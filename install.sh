...
_dev() {
  ...
  commands="init setup new ls attach kill hub dashboard ports logs url supabase pr shell worktree img projects update help status restart send diff sync gc template config agent stats doctor web bot services notify mobile m task ask vibes fortune lenny"
